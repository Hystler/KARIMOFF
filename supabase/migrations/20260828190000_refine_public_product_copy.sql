...
with public_copy(aliases, name, description) as (
  values
    ...
    (array['chickenburger'], 'Чикенбургер', 'Хрустящая куриная котлета, чеддер, свежие овощи и фирменный чесночный соус.'),
    (array['chicken-roll'], 'Чикенролл', 'Куриная котлета с чеддером, свежими овощами и чесночным соусом в тортилье.'),
    (array['beef-roll'], 'Бифролл', 'Говяжья котлета с чеддером, овощами и фирменным барбекю в горячей тортилье.'),
    (array['tatarin'], 'Татарин', 'Три говяжьи котлеты, шесть ломтиков чеддера, картофель фри, овощи и два соуса.'),
    ...
    (array['mini-shaurma'], 'Мини-шаурма', 'Компактная шаурма с курицей, свежими овощами и фирменным чесночным соусом.'),
