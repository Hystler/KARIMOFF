...
function getMessage(params: Awaited<NonNullable<AdminVacanciesPageProps["searchParams"]>>) {
  ...
  if (params.error) {
    return { tone: "error", text: "Не удалось выполнить действие. Примените актуальные миграции PostgreSQL." };
  }
      ...
      <div className="mx-auto w-full max-w-7xl">
        <header className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <h1 className="mt-2 text-3xl font-black leading-tight sm:text-4xl">Вакансии</h1>
          </div>
