  ...
  return (
    <main className="bg-karimoff-cream pt-28 text-karimoff-black">
      <section className="container-page pb-12 pt-6 sm:pb-16">
        <div className="grid grid-cols-1 gap-7 rounded-[1.75rem] border border-karimoff-line bg-white p-6 shadow-[0_24px_70px_rgba(18,18,20,0.08)] sm:p-9 lg:grid-cols-[1.02fr_0.98fr] lg:items-end">
          <div className="min-w-0">
            <p className="text-sm font-semibold text-karimoff-orange">О нас</p>
            <h1 className="mt-4 max-w-3xl text-balance text-4xl font-black leading-[1.02] sm:text-5xl lg:text-6xl">
