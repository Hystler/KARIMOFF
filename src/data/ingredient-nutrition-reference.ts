...
const label = (
  ...
  ...(unitWeightG !== undefined ? { unit_weight_g: unitWeightG } : {}),
...
export const ingredientNutritionReference: readonly IngredientNutritionReference[] = [
  ...
  estimatedPiece("Лаваш", 74, 275, 9.1, 1.2, 55.7, "Тестовый аналог белой питы; фактическая масса большого лаваша 74 г.", 174915),
  ...
  estimatedPiece("Лепёшка", 180, 275, 9.1, 1.2, 55.7, "Тестовый аналог белой питы; фактическая масса лепёшки 180 г.", 174915),
  label("Тортилья", "g", 100, 320, 7.5, 8.5, 52, "Этикетка на 100 г; производственная порция 80 г."),
  estimated(
    "Курица запечённая",
    169.66,
    28.85,
  ...
  label("Булочка для бургера белая", "pcs", 1, 213.2, 5.33, 2.46, 41, "Одна булочка 82 г; пересчёт этикетки с 100 г.", 82),
  label("Булочка для бургера чёрная", "pcs", 1, 240.3, 6.23, 5.34, 42.72, "Одна булочка 89 г; пересчёт этикетки с 100 г.", 89),
  label("Булочка для хот-дога открытая", "pcs", 1, 156, 4.2, 1.8, 30, "Одна датская булочка 60 г; пересчёт этикетки с 100 г.", 60),
  label("Булочка для хот-дога закрытая", "pcs", 1, 144, 4.8, 0.6, 29.4, "Один французский багет 60 г; пересчёт этикетки с 100 г.", 60),
  label("Котлета говяжья", "g", 100, 260, 13, 23, 1, "Котлета 110 г; КБЖУ этикетки указано на 100 г."),
  estimatedPiece("Котлета куриная", 110, 287, 14.8, 19.6, 12.8, "Тестовый аналог готовой куриной котлеты в панировке; масса порции 110 г.", 171513),
  estimatedPiece("Бекон жареный", 3, 541, 37, 41.8, 1.43, "Тестовый аналог готового жареного бекона; один ломтик 3 г.", 167712),
  label("Колбаска куриная", "pcs", 1, 168, 12, 12.8, 0.8, "Одна колбаска 80 г; пересчёт этикетки с 100 г.", 80),
  label("Колбаска свиная", "pcs", 1, 240, 5.6, 24, 0.8, "Одна колбаска 80 г; пересчёт этикетки с 100 г.", 80),
  label("Колбаска говяжья", "pcs", 1, 216, 12, 18.4, 0.8, "Одна колбаска 80 г; пересчёт этикетки с 100 г.", 80),
  estimated("Свинина запечённая", 292, 23.3, 21.4, 0, "Тестовый аналог запечённой свиной лопатки с жиром; заменить данными поставщика.", "USDA FoodData Central / SR Legacy", 167844, srLegacySourceURL),
  estimated("Говядина запечённая", 236, 24.6, 15.3, 0, "Тестовый аналог запечённой говяжьей лопатки с жиром; заменить данными поставщика.", "USDA FoodData Central / SR Legacy", 170820, srLegacySourceURL),
  ...
  label("Наггетс", "pcs", 1, 39.9, 2.09, 2.09, 3.04, "Средняя фактическая масса 19 г из диапазона 18–20 г; пересчёт этикетки с 100 г.", 19),
  label("Огурец маринованный", "g", 100, 15, 1, 0, 4, "Этикетка на 100 г; жиры не указаны и приняты равными 0 г."),
  label("Халапеньо", "g", 100, 15, 0.5, 0, 3.5, "Этикетка Metro Chef на 100 г; жиры не указаны и приняты равными 0 г."),
  label("Лук жареный гранулированный", "g", 100, 530, 8.1, 49.5, 47.7, "Этикетка на 100 г."),
  label("Сыр Чеддер, ломтик", "pcs", 1, 33, 1.84, 2.65, 0.45, "Один ломтик 10 г; пересчёт этикетки с 100 г.", 10),
  label("Сырная палочка", "pcs", 1, 41.19, 2.35, 2, 3.5, "Одна палочка 23 г; пересчёт этикетки с 100 г.", 23),
  ...
  label("Соус медово-горчичный", "g", 100, 230, 0.5, 22, 8.5, "Этикетка Metro Chef на 100 г."),
